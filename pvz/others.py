...
class SunBox(pygame.sprite.Sprite):
    ...
    def __init__(self, gameDisplay, allSprite):
        ...
        self.add_to_screen(gameDisplay)
        allSprite.add(self)

    def add_to_screen(self, gameDisplay):
        myfont = pygame.font.SysFont(pygame.font.get_default_font(), 20)
        scoretext = myfont.render(str(self.sun_capacity), 1, (0, 0, 0))  # black
    ...
    def update(self, sun_amount, gameDisplay):
